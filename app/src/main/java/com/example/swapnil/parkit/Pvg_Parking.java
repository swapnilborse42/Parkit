...
public class Pvg_Parking extends AppCompatActivity {
    TextView total_park;
    int total=function();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pvg__parking);
        total_park= (TextView) findViewById(R.id.total_park_pvg);
    }

    public void decpvg(View view) {
        ...
        myRef.child("Pvg_Parking").child("total").setValue(total);
        total=total-1;
        myRef.child("Pvg_Parking").child("total").setValue(total);
        // textView2.setText(total);

        final DatabaseReference orders_Reference = myRef.child("Pvg_Parking");
    ...
    public int function() {
        ...
        final DatabaseReference orders_Reference = myRef1.child("Pvg_Parking");
